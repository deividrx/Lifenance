 ...
 * @author galdi
 */
public class JDialogBancoAlterar extends javax.swing.JDialog {
    
    private String id;
    
    public JDialogBancoAlterar(java.awt.Frame parent, boolean modal, String id) {
        super(parent, modal);
        this.id = id;
        initComponents();
    ...
    private void jButtonSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonSalvarActionPerformed
        try {
            ...
            Banco objBanco = new Banco(Integer.parseInt(id), nomeDoBanco);
            BancoControle objBancoControle = new BancoControle();
            objBancoControle.alterar(objBanco);
