                ...
                <div class="col-lg-7 mx-auto">
                  <div class="bg-white rounded-lg shadow-sm p-5">
                    ...
                    <div class="tab-content">
                        ...
                        <form id="register-card" role="form">
                          ...
                          <div class="form-group">
                            ...
                            <div class="input-group">
                              <input type="text" name="cardNumber" placeholder="Número do cartão" class="form-control"
                                required>
                            </div>
                          </div>
                          ...
                          <div class="row">
                            ...
                            <div class="col-sm-8">
                              <div class="form-group">
                                ...
                                <div class="input-group">
                                  <input type="number" min="1" max="12" placeholder="Mês" name="validadeMes"
                                    class="form-control" required>
                                  <input type="number" min="1900" max="2100" placeholder="Ano" name="validadeAno"
                                    class="form-control" required>
                                </div>
                              </div>
                            </div>
                            ...
                            <div class="col-sm-4">
                              <div class="form-group">
                                ...
                                <input type="text" required="required" placeholder="%" name="card-multa"
                                  pattern="[0-3]+$" required class="form-control">
                              </div>
                            </div>
                          ...
                          <div class="row">
                            <div class="col-sm-8">
                              <div class="form-group">
                                ...
                                <div class="input-group">
                                  <input type="number" min="1" max="31" placeholder="Dia" name="fatura-dia"
                                    class="form-control" required>
                            ...
                            <div class="col-sm-4">
                              ...
                              <div class="form-group mb-4">
                                <label data-toggle="tooltip" title="Tres digitos na parte de trás do cartão">Bandeira
                                </label>
                                <select name="bandeira" id="selectbody" class="custom-select mr-sm-2"
                      ...
                      <button form="register-card" type="submit"
                        class="subscribe btn btn-primary btn-block rounded-pill shadow-sm"> Confirmar </button>
                      <!-- End -->
                    </div>
                    <!-- End -->
